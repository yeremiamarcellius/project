...
<nav class="flex flex-row bg-gradient-to-b fixed top-0 from-purple-600 bg-opacity-50 justify-between w-full">
    ...
    <div class="bg-ocean flex flex-row justify-between rounded-bl-3xl p-2 w-60 xl:w-80 h-1/2">
        <a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href=""><img height="50px" width="50px" src="/images/svgs/nav-admin-pay.svg" alt="nav.svg"></a>
        <a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href=""><img height="50px" width="50px" src="/images/svgs/nav-admin-part.svg" alt="nav.svg"></a>
        <form><a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href="../index.html"><img height="50px" width="50px" src="../photos/svgs/nav-admin-logout.svg" alt="nav.svg"></a></form>
    </div>
</nav>
            ...
            <div class="w-full md:w-1/2 xl:w-80 2xl:w-96 p-0 mt-8 md:p-4 lg:p-8">
                <div class="w-full flex flex-row rounded-xl bg-purples hover:bg-purple-900 p-8">
                    <div class="w-3/4 mr-4 flex flex-col justify-center">
                        <h1 class="text-white font-semibold text-xl text-center tracking-widest">NAME</h1>
...
<!-- PopUp Images -->
<section class="flex hidden items-center content-center bg-black absolute top-0 h-screen bg-opacity-50 w-full" id="popUpBackground">
    <div class="popUp-Content shadow-inner absolute hidden sm:max-w-80 transform -translate-y-1/2 -translate-x-1/2 z-50 py-4 px-8 bg-dust rounded-xl top-1/2 left-1/2" id="examplePopUpContent">
        <div class="flex flex-col justify-center items-center">
            <h1 class="text-center font-semibold text-3xl text-white tracking-widest">Payment</h1>
            <hr class="w-2/3 my-6 mx-auto">
            <img class="w-96 rounded-xl" src="../photos/Hackathon-2.0.jpg" alt="viewphoto.jpg">
        </div>
    </div>
</section>
<!-- PopUp Payment Status -->
<section class="flex items-center hidden content-center bg-black absolute top-0 h-screen bg-opacity-50 w-full" id="popUpPaymentStatus">
    <div id="statusPopUpContent" class="popUp-Status w-80 flex flex-col sm:w-96 hidden absolute top-4 transform -translate-x-1/2 z-50 py-4 bg-dust rounded-xl left-1/2" id="examplePopUpContent">
