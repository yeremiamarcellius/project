        ...
        <div class="container mx-auto">
            <div class="sm:flex justify-between mx-10">
                ...
                <ul class="text-white sm:self-center text-xl sm:border-none">
                    ...
                    <li class="sm:inline-block rounded-full"><a href="{{route('admin')}}" class="my-2 px-3 py-1 hover:text-red-500">Dashboard</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <nav class="z-40 flex lg:hidden bg-black bg-opacity-70 fixed top-0 w-screen">
        <div class="container mx-auto">
            ...
            <ul class="text-white self-center text-xl sm:border-none bg-black bg-opacity-90 flex flex-col" id="dropdown" style="display: none">
                ...
                <li class="inline-block w-full flex justify-center"><a href="{{route('admin')}}" class="my-2 px-3 py-1 hover:text-red-500 bg-black bg-opacity-50 rounded-2xl border-2 border-gradient">Dashboard</a></li>
            </ul>
        </div>
    </nav>
    <!-- Home -->
