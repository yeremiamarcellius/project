...
<body>
    <nav class="flex flex-row bg-gradient-to-b fixed top-0 from-purple-600 bg-opacity-50 justify-between w-full">
        <img src="../photos/ehackathon_logo_1.png" alt="" class="transform hover:scale-110 motion-reduce:transform-none ml-0 sm:ml-4 md:ml-8" height="100px" width="100px"/>
        <div class="bg-ocean flex flex-row justify-between rounded-bl-3xl p-2 w-60 xl:w-80 h-1/2">
            <a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href="#"><img height="50px" width="50px" src="../photos/svgs/nav-home.svg" alt="nav.svg"></a>
            <a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href="../pages/user-payment.html"><img height="50px" width="50px" src="../photos/svgs/nav-payment.svg" alt="nav.svg"></a>
            <a class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href="../pages/user-timeline.html"><img height="50px" width="50px" src="../photos/svgs/nav-timeline.svg" alt="nav.svg"></a>
            <form><button type="submit" class="mx-auto transform hover:scale-110 motion-reduce:transform-none flex justify-center items-center" href="../index.html"><img height="50px" width="50px" src="../photos/svgs/nav-admin-logout.svg" alt="nav.svg"></button></form>
        </div>
    </nav>
                    ...
                    <form class="flex flex-col justify-center items-center content-center">
                        ...
                        <div class="w-full flex flex-col">
                            ...
                            <div class="w-full flex flex-row">
                                ...
                                <button data-target="examplePopUpContent1" id="examplePopUpToggle1" class="ml-4 transform hover:scale-110 motion-reduce:transform-none focus:outline-none mr-2 h-full"><img class="m-0 h-8" src="../photos/svgs/view-toggle.svg" alt=""></button>
                            </div>
                        ...
                        <div class="w-full flex flex-col">
                            ...
                            <div class="w-full flex flex-row">
                                <input class="w-4/5 text-white text-base font-light ml-2 rounded-lg border-white flex justify-between bg-transparent border-2 h-8"></input>
                                <button data-target="examplePopUpContent2" id="examplePopUpToggle2" class="ml-4 transform hover:scale-110 motion-reduce:transform-none focus:outline-none mr-2 h-full"><img class="m-0 h-8" src="../photos/svgs/view-toggle.svg" alt=""></button>
                            </div>
                        </div>
