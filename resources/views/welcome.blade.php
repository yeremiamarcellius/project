...
<body>
    <!-- Nav for web -->
    <nav class="z-40 hidden lg:flex bg-black bg-opacity-70 fixed top-0 w-screen">
        <div class="container mx-auto">
            <div class="sm:flex justify-between mx-10">
                ...
                <ul class="text-white sm:self-center text-xl sm:border-none">
                    ...
                    <li class="sm:inline-block"><a href="{{route('login')}}" class="my-2 px-3 py-1 hover:text-red-500 rounded-2xl border-2 border-gradient">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
