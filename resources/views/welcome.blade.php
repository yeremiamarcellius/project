            ...
            <div class="lg:ml-auto w-full lg:w-2/3 xl:w-1/2">
                ...
                <div class="flex flex-col sm:flex-row justify-evenly">
                    ...
                    <div class="flex flex-col font-semibold text-2xl">
                        ...
                        <a href="#"><div class="transform hover:scale-110 motion-reduce:transform-none bg-ocean h-16 md:h-20 rounded-md text-white text-center text-xl md:text-2xl w-56 md:w-64 font-bold flex flex-col justify-center">Download</div></a>
                    </div>
                </div>
            </div>
        </div>
